<?php
	...
	$records = mysqli_query($db,"select * from home_reg");
	$num = 1;
?>
		    ...
		    <div class="collapse navbar-collapse" id="navbarNavDropdown">
		      <ul class="navbar-nav">
		        ...
		        <li class="nav-item dropdown">
		          ...
		          <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
				  <li><a class="dropdown-item active" href="#" style="color: black;">Home</a></li>
				...
				<div class="col-4 ">
					<div class="card" style="width: 18rem;">
						...
						<div class="card-body">
						    ...
						    <p>Cost : <?php echo $rows['cost']; ?> </p>
						    <p>Number per room : <?php echo $rows['numberperroom']; ?> </p>
