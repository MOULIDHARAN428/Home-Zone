<?php
	...
	$records = mysqli_query($db,"select * from refugee_reg");
	$num = 1;
?>
...
<body>
		      ...
		      <ul class="navbar-nav">
		        ...
		        <li class="nav-item dropdown">
		          ...
		          <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
		            ...
		            <li><a class="dropdown-item" href="../html/refugee.html" style="color: black;">Refugee</a></li>
		          </ul>
		        </li>
		        <li class="nav-item dropdown">
		          <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false" style="color: black;">
		          ...
		          <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
		            ...
		            <li><a class="dropdown-item" href="homeless_list.php" style="color: black;">Homeless</a></li>
		            <li><a class="dropdown-item active" href="#" style="color: black;">Refugee</a></li>
		          </ul>
		        </li>
			...
			<div class="col-sm-4 col-12">
				<div class="card" style="width: 18rem;">
					...
					<div class="card-body">
					    ...
					    <p>Current Stay : <?php echo $rows['current_stay'];?></p>
	...
	<section class="footer">
		<footer>
		<p id="copyright" style="text-align: center;">Copyright &copy; 2021 <a href="https://macodeid.com/" target="_blank">Home Zone</a>. All right reserved</p>
	</footer></section> 
